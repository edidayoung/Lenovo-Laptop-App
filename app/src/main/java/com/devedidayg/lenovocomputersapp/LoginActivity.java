...
import com.devedidayg.lenovocomputersapp.Database.Database;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String next = "<font color='#87CBB9'>Register Here</font>";
            ...
            public void onClick(View view) {
                ...
                if (username.length()==0 || password.length()==0){
                    ...
                    if (db.login(username,password)>0){
                        Toast.makeText(LoginActivity.this, "Welcom to LENOVO HUB", Toast.LENGTH_SHORT).show();
